...
| `demo-greeting-lib` | `samples` | `projects/demo-greeting-lib` | ライブラリ構成サンプル |
| `demo-math-lib` | `samples` | `projects/demo-math-lib` | ライブラリ構成サンプル |
...
| `workspace-consumer-demo` | `samples` | `projects/workspace-consumer-demo` | workspace 利用デモ |
