...
} from '#/client/features/chat/components/assistant-code-block'
...
import { DeleteIcon } from '#/client/shared/icons/delete-icon'
import { EditIcon } from '#/client/shared/icons/edit-icon'
